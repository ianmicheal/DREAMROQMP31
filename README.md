# DREAMROQMP31
Mod of dreamroq with mp3 support example has a mp3 baked in video streams from disk really not a good example works for skip-able boot intro of a video not in sync
Ian micheal
